...
float calculateIntegral(float functionId, float a, float b, int n, int intensity, int nbthreads){
...
int main (int argc, char* argv[]) {
  ...
  float response = (float) calculateIntegral(functionId, a, b, n, intensity, nbthreads);
